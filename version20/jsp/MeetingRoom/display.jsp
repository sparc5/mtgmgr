...
<div id="dock" class="ui-widget-header" style="border-top: none;">
	<ul>
		...
		<li class="ui-widget-content"><span class="ui-icon icon-action_items"></span><a class="clickable" mtgRmId='<s:property value="#mtgRmId"/>' details="actionItems">Outstanding action items</a></li>
